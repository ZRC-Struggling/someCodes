myFocus.extend({//*********************配件商城风格******************
	mF_peijianmall:function(par){
		var box=this.$(par.id);
		this.addList(box,['txt']);
		var pics=this.$c('pic',box),txt=this.$li('txt',box),n=txt.length,param={};//运行时相关参数
...
myFocus.setting.prototype.param('mF_peijianmall',{//额外参数设置
